...
(Claude models on this path use the Anthropic Messages API instead — see 03_hello_mantle_anthropic.py)
...
# Note: OSS/Nova models use /v1 base path. GPT-5.5 uses /openai/v1 (see 05_hello_codex.py)
client = OpenAI(
